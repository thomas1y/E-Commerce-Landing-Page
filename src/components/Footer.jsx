...
const tweetList = [
    {
        iconName: 'icofont-twitter',
        desc: <p>Thomas<a href="#">@ShopCart Greetings!  #HTML_Template</a> Grab your item, 50% Big Sale Offer !!</p>,
    },
    {
        iconName: 'icofont-twitter',
        desc: <p> Yohannes<a href="#">@ShopCart Hey! #HTML_Template</a> Grab your item, 50% Big Sale Offer !!</p>,
    },
]
      ...
      <div className='footer-bottom'>
          <div className='container'>
              <div className='section-wrapper'>
                   <p>&copy; 2023 <Link to="/">Shop Cart</Link>Designed by <a href="/" target="_blank">Thomas</a></p>
